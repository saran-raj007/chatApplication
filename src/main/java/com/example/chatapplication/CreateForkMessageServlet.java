        ...
        try{
            if(!isGroup){
                ...
                while (msg_data && fileData) {
                    ...
                    try {
                        parsedDate = (Timestamp) dateFormat.parse(created_at);
                    } catch (ParseException e) {
                        throw new RuntimeException(e);
                    }
                    ...
                    if(parsedDate_msg.compareTo(timestamp)>=0){
                        ...
                        JsonArray keysArray = jsonObject.getAsJsonArray("keys");
                        ...
                        insetKeys(forkId,senderId,receiverId,message,iv,parsedDate,keysMap);
                        ...
                        insertFiles(sender_id_file,forkId,file_name);
                    }
...
//    }
    ...
    private void insetKeys(String fork_id, String sender_id, String receiver_id, String message, String iv, Date parsedDate, Map<String, String> keysMap){
        Connection con = DBconnection.getConnection();
        PreparedStatement ps;
        if(con != null){
            ...
            try{
                ...
                ps.setString(5, iv);
                ps.setTimestamp(6, new Timestamp(parsedDate.getTime()));
    ...
    private void insertFiles(String sender_id, String fork_id, String file_name){
        Connection con = DBconnection.getConnection();
        PreparedStatement ps;
        if(con != null){
